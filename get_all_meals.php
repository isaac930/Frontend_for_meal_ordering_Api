...
<td><a href="edit_meal?id=<?php echo $meal->id ?>&token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&email=<?php echo $email ;?>">
     <button type="button" class="btn btn-success">Edit</button>
    </a></td>
   
    <td><a href="delete_meal?id=<?php echo $meal->id ?>&token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&email=<?php echo $email ;?>">
     <button type="button" class="btn btn-danger">Delete</button>
    </a></td>

     <td><a href="get_single_meal?id=<?php echo $meal->id ?>&token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&email=<?php echo $email ;?>">
