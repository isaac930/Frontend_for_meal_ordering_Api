...
<!-- Topbar Navbar -->
                ...
                <div class="container-fluid">
                    ...
                    <h4 style="color:red;">ADD NEW MEAL DETAILS</h4>
...
$url_path = 'https://stormy-cove-15358.herokuapp.com/api/auth/meal';
...
if ( window.history.replaceState ) {
  window.history.replaceState( null, null, window.location.href );
                            ...
                            <form class="user" name="addmeal" id="form" action="addmeal?token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&email=<?php echo $email;?>" method="post" role="form" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <Textarea name="details" class="form-control form-control-user" id="exampleInputEmail"
                                        placeholder="Details" required=""></Textarea>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="text" name="price" class="form-control form-control-user"
                                            id="exampleInputPassword" placeholder="Price" required=""/>
                                    </div>
                                   <hr>
                    
                                    <div class="form-group">
                                    <div class="col-sm-12">
                                        <input type="file" name="file" class="btn btn-success btn-user btn-block" required=""/>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                ...
                                <hr>
                                <input type="submit" name ="save" value="ADD MEAL" class="btn btn-primary btn-user btn-block"> 
