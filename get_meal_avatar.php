    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="dashboard?token=<?php echo $_GET['token'];?>&usertype=<?php echo $usertype;?>">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="addmeal?token=<?php echo $token ;?>&usertype=<?php echo $_GET['usertype'] ;?>">Add New Meal</a>
                        <a class="collapse-item" href="get_all_meals?token=<?php echo $token ;?>&usertype=<?php echo $_GET['usertype'] ;?>">View Meals</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="addmenu?token=<?php echo $token ;?>&usertype=<?php echo $_GET['usertype'] ;?>">Add New Menu</a>
                        <a class="collapse-item" href="get_all_menu?token=<?php echo $token ;?>&usertype=<?php echo $_GET['usertype'] ;?>">View Menu</a>
...
$meal_name = $_GET['meal_name'];
$url = "https://stormy-cove-15358.herokuapp.com/api/auth/getmealavatar";
...
$path = $outputArray->{'meal_avatar_path'};
...
?> 
                    ...
                    <h4 style="color:red;">MEAL AVATAR</h4>
...
<center>
    <h4>
<?php echo $_GET['meal_name']; ?>
</h4>
<br/>
<?php $baseurl = "https://isaacbucketenock.s3.us-east-2.amazonaws.com/meals/"; ?>
<img src="<?php echo $baseurl.$path; ?>" width="350" height="350" class="rounded-circle" alt="profile-picture" border="0" />
</center>                               
