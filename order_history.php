...
?>
 ...
 <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">THIS IS ALL YOUR ORDERING HISTORY STARTING WITH LATEST ORDERS</h6>
...
$url = "https://stormy-cove-15358.herokuapp.com/api/auth/userordershistory"; 
