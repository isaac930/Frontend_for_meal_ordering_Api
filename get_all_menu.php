...
?>
 ...
 <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">CURRENT DATE MENU (TODAY`S MENU)</h6>
                        </div>
                        <div class="card-body">
            ...
            <tr class="table-danger">
                ...
                <td scope="col">MENU VALIDITY</td>
                <td scope="col">EDIT</td>
                <td scope="col">DELETE</td>
                <td scope="col">SINGLE MENU</td>
...
foreach ($menu_data as $menu) {
    ...
    echo '<td>'.$menu->details.'</td>';
    echo '<td>'.$menu->price.'</td>';
    echo '<td>'.$menu->menu_validity.'</td>';
?> 

<td><a href="edit_menu?token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&email=<?php echo $email ;?>&meal=<?php echo $menu->meal_name; ?>&id=<?php echo $menu->id ?>">
     <button type="button" class="btn btn-success">Edit</button>
    </a></td>
   
    <td><a href="delete_menu?id=<?php echo $menu->id ?>&usertype=<?php echo $usertype; ?>&token=<?php echo $token; ?>&email=<?php echo $email ;?>">
     <button type="button" class="btn btn-danger">Delete</button>
    </a></td>

     <td><a href="get_single_menu?id=<?php echo $menu->id ?>&usertype=<?php echo $usertype; ?>&token=<?php echo $token; ?>&email=<?php echo $email ;?>">
