...
$url = "https://stormy-cove-15358.herokuapp.com/api/auth/menu/$id"; //api meal get end point

 //api meal get end point
...
<td><a href="edit_menu?token=<?php echo $token; ?>&email=<?php echo $email ;?>&usertype=<?php echo $usertype; ?>&meal=<?php echo $menu->meal_name; ?>&id=<?php echo $menu->id ?>">
     <button type="button" class="btn btn-success">Edit</button>
    </a></td>
   
    <td><a href="delete_menu?id=<?php echo $id ?>&token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&email=<?php echo $email ;?>">
     <button type="button" class="btn btn-danger">Delete</button>
    </a></td>

     <td><a href="get_single_menu?id=<?php echo $id ?>&token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&email=<?php echo $email ;?>">
