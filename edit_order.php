...
<!-- Topbar Navbar -->
                ...
                <div class="container-fluid">
                    ...
                    <h4 style="color:red;">EDIT ORDER</h4>
...
$data = array('meal_ordered'=> $meal_name, 'quantity' => $quantity);
...
$url = "https://stormy-cove-15358.herokuapp.com/api/auth/order/$editid";
...
header("Location:get_orders?token=$token&usertype=$usertype&message=$message");
?>
</div>
...
<?php
// lets get a single order item we want to u
// Initiate curl session in a variable (resource)
$curl_handle = curl_init();

$authorization = "Authorization: Bearer ".$token; //authorization bearer token

$url = "https://stormy-cove-15358.herokuapp.com/api/auth/menu"; //api meal get end point
...
$meals_on_menu = $response_data->menu;
...
<form class="user" name="edit_order" id="form" action="edit_order?token=<?php echo $token; ?>&usertype=<?php echo $usertype;?>" method="post" role="form">
...
<div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
<select name="meal_name" class="form-control" id="exampleLastName" required="">
<option><?php echo $meal; ?></option>

<?php
foreach ($meals_on_menu as $meal_item) {
?>
<option><?php echo $meal_item->meal_name ;?></option>
...
<input type="text" name="quantity" class="form-control form-control-user"
id="exampleInputPassword" placeholder="quantity" value="<?php echo $qty ;?>" required=""/>
 </div>
                                ...
                                <hr>
                                <input type="submit" name ="update" value="UPDATE MEAL ON MY ORDER" class="btn btn-primary btn-user btn-block"> 
