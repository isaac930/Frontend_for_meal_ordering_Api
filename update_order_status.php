...
?>
 ...
 <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">ALL CURRENT DATE ORDERS</h6>
            ...
            <tr class="table-danger">
                ...
                <td scope="col">UPDATE ORDER STATUS</td>
...
$url = "https://stormy-cove-15358.herokuapp.com/api/auth/ordershistory"; //api meal get end point
...
?> 
    ...
    <td><a href="update_status?id=<?php echo $order->id ?>&token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&email=<?php echo $order->order_owners_email ;?>&contact=<?php echo $order->contact; ?>">
