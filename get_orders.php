            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="get_all_meals?token=<?php echo $token ;?>&email=<?php echo $_GET['email'] ;?>">View Meals</a>
...
<h6 class="m-0 font-weight-bold text-danger"> 
    <a href="order_history?token=<?php echo $token ;?>&usertype=<?php echo $usertype; ?>&email=<?php echo $_GET['email'] ;?>">
    <button type="button" class="btn btn-danger">MY ORDERING HISTORY</button>
</a></h6>
...
?>
 ...
 <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">BELOW ARE MY ORDERS FOR TODAY</h6>
...
$url = "https://stormy-cove-15358.herokuapp.com/api/auth/order"; //api meal get end point
...
foreach ($order_data as $order) {
    ...
    echo '<td>'.$order->order_placed_by.'</td>';
    echo '<td>'.$order->order_owners_email.'</td>';
    echo '<td>'.$order->contact.'</td>';
    echo '<td>'.$order->meal_ordered.'</td>';
    echo '<td>'.$order->quantity.'</td>';
    echo '<td>'.$order->price_per_meal.'</td>';
    echo '<td>'.$order->total_bill.'</td>';
    echo '<td>'.$order->order_status.'</td>';
  
?> 

    <td><a href="delete_order?id=<?php echo $order->id ?>&token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&email=<?php echo $email ;?>">
