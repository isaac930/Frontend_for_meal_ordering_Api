...
<!-- Topbar Navbar -->
                ...
                <div class="container-fluid">
                    ...
                    <h4 style="color:red;">EDIT ITEM ON MENU</h4>
...
$url = "https://stormy-cove-15358.herokuapp.com/api/auth/menu/$editid";
...
<form class="user" name="edit_menu" id="form" action="edit_menu?token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>" method="post" role="form">
...
?>
                                ...
                                <hr>
                                <input type="submit" name ="update" value="UPDATE MEAL ON MENU" class="btn btn-primary btn-user btn-block"> 
