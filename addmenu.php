...
<!-- Topbar Navbar -->
                ...
                <div class="container-fluid">
                    ...
                    <h4 style="color:red;">ADD MEAL ON TODAY`S MENU</h4>
...
$url_path = 'https://stormy-cove-15358.herokuapp.com/api/auth/menu';
...
$data = array('meal_name' => $meal_name);
...
<?php
   ...
   header("Location:get_all_menu?token=$token&usertype=$usertype&message=$message");
...
?>
                            <form class="user" name="addmenu" id="form" action="addmenu?token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&email=<?php echo $email;?>" method="post" role="form">
                                <div class="form-group row">
                               
                                    <div class="col-sm-12">
<select name="meal_name" class="form-control form-select-lg md-8"  aria-label=".form-select-lg example" id="exampleLastName" required="">
...
?>
                                ...
                                <hr>
                                <input type="submit" name ="save" value="ADD MEAL ON MENU" class="btn btn-primary btn-user btn-block"> 
