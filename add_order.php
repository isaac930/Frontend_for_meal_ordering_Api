...
<!-- Topbar Navbar -->
                ...
                <div class="container-fluid">
                    ...
                    <h4 style="color:red;">ADD YOUR MEAL ORDER FOR TODAY</h4>
...
$url_path = 'https://stormy-cove-15358.herokuapp.com/api/auth/order';
...
$data = array('meal_ordered' => $meal_name, 'meal_quantity' => $quantity);
...
<?php
//lets get all meals to put in a drop down list
...
?>
                            <form class="user" name="add_order" id="form" action="add_order?token=<?php echo $token; ?>&usertype=<?php echo $usertype; ?>&email=<?php echo $email;?>" method="post" role="form">
...
?>
<option><?php echo $meal->meal_name ;?></option>
...
<div class="form-group">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="text" name="quantity" class="form-control form-control-user"
                                            id="exampleInputPassword" placeholder="quantity" required=""/>
                                    </div>
                                ...
                                <hr>
                                <input type="submit" name ="save" value="SUBMIT ORDER" class="btn btn-primary btn-user btn-block"> 
